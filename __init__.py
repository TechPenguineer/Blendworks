...
from . bwu_pnl import BWU_PHYSICS_PANEL, POLY_WINDOW_CONTEXT
...
classes = (BWU_OT_Apply_All_Op, BWU_OT_Remove_All_Op, BWU_PHYSICS_PANEL, BWU_OT_Add_Rigidbody_Op, BWU_OT_Add_Rigidbody_Passive_Op, BWU_OT_Remove_Rigidbody_Op,
           BWU_OT_Physics_Settings_Friction_Op,OBJECT_OT_pyhsics_settings, BWU_CONTEXT_MENU_OP, change_lod, POLY_WINDOW_CONTEXT )
